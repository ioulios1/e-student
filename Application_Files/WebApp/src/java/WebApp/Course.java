...
public class Course extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        String lessID=request.getQueryString();
        ...
        JSONObject lessonJson=rc.getLesson(lessID,usr, key);
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println (lessonJson.getJSONObject("lesson").getString("name")+" id : "+lessID+" semester : "+lessonJson.getJSONObject("lesson").getString("semester")+"<br>");
            out.println("Description :<br>");
            out.println(lessonJson.getJSONObject("lesson").getString("description")+"<br>");
            out.println("</div>");
            out.println("</div>");
            out.println("</body>");
            out.println("</html>");
